...
public class Constants {
    ...
    public static int POWERSHOT_VELOCITY = 1500;
    ...
    public static double FEED_HOME_POS = 1;
    public static double FEED_MID_POS = 0.48;
    public static double FEED_TOP_POS = 0.13;
