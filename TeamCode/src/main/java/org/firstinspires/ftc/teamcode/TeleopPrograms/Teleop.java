...
//            }
            ...
            if (gamepad2.a) {
                ...
                robot.drivetrain.setGlobalControls(MecanumDrivetrain.yKp * (63 - robot.y) + MecanumDrivetrain.yKd * (-robot.vy), gamepad1.left_stick_y * xySpeed, MecanumDrivetrain.thetaKp * (-robot.shootTargets(3)[2]) + MecanumDrivetrain.thetaKd * (-robot.w));
            }
